...
insert into Sinhvien values ('001','addt',cast('2002-08-2' as date), 'L01')
insert into Sinhvien values ('002','addt1',cast('2002-03-19' as date), 'L02')
insert into Sinhvien values ('003','addt2',cast('2002-04-5' as date), 'L03')
